...
class ResourceTableGatewayFactory implements FactoryInterface
{
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        $tableGateway = new TableGateway('resource', $dbAdapter, null, $resultSetPrototype);
        return new ResourceTableGateway($tableGateway);
    }
}